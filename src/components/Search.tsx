...
export function Search({ className }: Props) {
  return (
    <form className={`flex items-center max-w-sm mx-auto ${className}`}>
      ...
      <button
        type="submit"
        className="p-2.5 ms-2 text-sm font-medium text-white bg-primary rounded-lg border border-primary hover:bg-primary focus:ring-4 focus:outline-none focus:ring-primary dark:bg-primary dark:hover:bg-yellow-600 dark:focus:ring-primary"
      >
        <svg
          className="w-4 h-4"
          aria-hidden="true"
